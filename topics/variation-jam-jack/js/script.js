...
constructor (speed,size,start){
    x = 0,//moves across screen from initated position
    y = 0,//random from surface to floor of screen 
    size = 0,//random 
    value = 0,//ranges depending on different size caps (ex: 1-5 = $10 6-10 = $15 etc)
    speed = 0,//random but pretty slow
    start = 0,//randomizes right moving or left moving
    radius = 0//invisible rectangle around fish that is its detection radius, = size * by random number
}
}
...
function moveFish() {
    ...
    if (fish x is past the its opposite side of the canvas){
        ...
        give the fish a random y position
    } 
}
